...
def main(args):
	...
	path_log = os.path.join(args.save_path, 'jig'+str(args.jigsaw_version)+'_results', 'cross', 'Sketchy', save_folder_name)
	...
	if os.path.isfile(best_model_file):
		...
		path_cp_ttt = os.path.join(args.save_path, 'jig'+str(args.jigsaw_version)+'_models', 'cross', 'Sketchy', save_folder_name)
