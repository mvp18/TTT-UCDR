...
def main(args):
	...
	path_log = os.path.join(args.save_path, 'rotnet'+str(args.rotnet_version)+'_results', args.dataset, save_folder_name)
	...
	data_ttt = BaselineDataset(np.array(data_splits_ttt), transforms=image_transforms['pre-rotate'])
	...
	if os.path.isfile(best_model_file):
		...
		path_cp_ttt = os.path.join(args.save_path, 'rotnet'+str(args.rotnet_version)+'_models', args.dataset, save_folder_name)
