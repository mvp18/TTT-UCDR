...
def main(args):
	...
	path_log = os.path.join(args.save_path, 'BT2_results', args.dataset, save_folder_name)
	...
	if os.path.isfile(best_model_file):
		...
		path_cp_ttt = os.path.join(args.save_path, 'BT2_models', args.dataset, save_folder_name)
